...
:: ---------------------------------------------------------
:: 2b. Start ZKTeco Bridge service (if present)
:: ---------------------------------------------------------
if exist "%~dp0bridge\HackGym.ZKTeco.Bridge.exe" (
    echo [INFO] Starting ZKTeco Bridge...
    start "ZKTeco Bridge" /MIN "%~dp0bridge\HackGym.ZKTeco.Bridge.exe"
    echo [OK] ZKTeco Bridge started.
)
