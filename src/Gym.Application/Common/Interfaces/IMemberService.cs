...
public interface IMemberService
{
    ...
    Task<Result<List<MemberDto>>> GetAllMembersAsync(CancellationToken cancellationToken = default);
    Task<Result<List<MemberExportDto>>> GetAllMembersForExportAsync(CancellationToken cancellationToken = default);
